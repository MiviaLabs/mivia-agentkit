...
func TestDoctorFailsWhenStrictRequiresAGTButSDKUnavailable(t *testing.T) {
	...
	assertCode(t, got, "governance.provider_unavailable")
	if got.ExitCode != 1 {
		t.Fatalf("ExitCode = %d, want 1 for strict AGT SDK unavailable", got.ExitCode)
	}

...
func newPreflightCommand() *cobra.Command {
	...
	cmd.Flags().StringArrayVar(&ctx.FocusedVerifiers, "focused-verifier", nil, "focused verifier command")
	cmd.Flags().StringArrayVar(&ctx.BroadVerifiers, "broad-verifier", nil, "broad verifier command")

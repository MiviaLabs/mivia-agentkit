...
- Existing target files under `docs/plans/`

## Method

1. Define exact scope and exclusions before writing a plan.
2. Re-read current source, tests, hooks, skills, rules, policies, docs, and existing `docs/plans/*.md` relevant to the requested scope.

...
description: Claude Code adapter for mivia-agent workflow execution, run artifacts, and desktop-agent workflow routing.
triggers:
...
Read `.ai/skills/mivia-agent-workflows/SKILL.md` first. Follow `AGENTS.md`, `CLAUDE.md`, `.ai/INDEX.md`, and `docs/desktop-agent-workflows.md`.
